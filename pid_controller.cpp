...
void PID::Init(double Kpi, double Kii, double Kdi, double o_maxi, double o_mini) {
   /**
   ...
   **/
   ...
   this->Ki = Kii;
   this->Kd = Kdi;
   this->output_lim_max = o_maxi;
   this->output_lim_min = o_mini;
}
...
double PID::UpdateDeltaTime(double new_delta_t) {
   /**
   * TODO: Update the delta time with new value
   */   
  this->delta_time = new_delta_t;
